...
public class CapturaDePantallaMovil {
  ...
  public static String tomarCapturaPantalla(String nombreCaptura) {
    ...
    try {
      ...
      String nombreArchivo = nombreCaptura + "_" + formattedDateTime + ".jpg";
      ...
      File destinoTemporal = new File(CAPTURAS_DIR + "temp.jpg");
      ...
      ImageIO.write(imagenConBorde, "jpg", destinoFinal);
