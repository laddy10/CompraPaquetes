...
public class TerminosYCondicionesDos extends AndroidObject implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        ejecutarAdbTap(420, 806);  // Simula un toque en las coordenadas
        ...
        ejecutarAdbTap(210, 808);  // Simula un toque en las coordenadas
        ...
        ejecutarAdbTap(358, 908);  // Simula un toque en las coordenadas

    }

    public static Performable terminosYCondicionesDos() {
        return instrumented(TerminosYCondicionesDos.class);
    }
}