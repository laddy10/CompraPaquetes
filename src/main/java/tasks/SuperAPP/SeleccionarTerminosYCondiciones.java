...
public class SeleccionarTerminosYCondiciones extends AndroidObject implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        ejecutarAdbTap(416, 840);  // Simula un toque en las coordenadas
        ...
        ejecutarAdbTap(207, 842);  // Simula un toque en las coordenadas
        ...
        ejecutarAdbTap(371, 945);  // Simula un toque en las coordenadas

    }

    public static Performable seleccionarTerminosYCondiciones() {
        return instrumented(SeleccionarTerminosYCondiciones.class);
    }
}