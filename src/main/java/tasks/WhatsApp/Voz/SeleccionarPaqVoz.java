...
public class SeleccionarPaqVoz implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ClickTextoQueContengaX.elTextoContiene(PAQ_VOZ_WH)
        );
    ...
    public static Performable seleccionarPaqVoz() {
        return instrumented(SeleccionarPaqVoz.class);
    }
}