...
public class EsperarYClickSeleccionaEnUltimoMensaje implements Interaction {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        while (true) {
            ...
            if (ultimoMsg != null) {
                // dentro
                List<WebElement> dentro = ultimoMsg.findElements(By.xpath(
                ...
                // hermano/adyacente
                List<WebElement> hermanos = ultimoMsg.findElements(By.xpath(
    ...
    private static WebElement ultimoChipSeleccionaVisible(org.openqa.selenium.WebDriver driver, String label) {
        // candidatos: texto o content-desc "Selecciona", preferible clickable/focusable
        List<WebElement> cand = driver.findElements(By.xpath(
        ...
        List<WebElement> visibles = cand.stream().filter(el -> {
            try {
