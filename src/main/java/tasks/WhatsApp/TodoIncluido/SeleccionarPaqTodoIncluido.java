...
import static utils.ConstantsPaquetes.PAQ_TODO_INCLUIDO_WH;


public class SeleccionarPaqTodoIncluido implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ClickTextoQueContengaX.elTextoContiene(PAQ_TODO_INCLUIDO_WH)
        );
    ...
    public static Performable seleccionarPaqTodoIncluido() {
        return instrumented(SeleccionarPaqTodoIncluido.class);
    }
}