...
public class Paq3_5GB_WFT_VozIlimi implements Task {

    String precioTexto = PRECIO_$13000_10DIAS;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(TODO_INCLUIDO_3_5GB_WFT_VOZ));

        CapturaDePantallaMovil.tomarCapturaPantalla("captura_pantalla");

        actor.attemptsTo(
                ClickTextoQueContengaX.elTextoContiene(ENVIAR2),
                ValidarTextoQueContengaX.elTextoContiene(PRECIO_$13000_10DIAS),
                ValidarTextoQueContengaX.elTextoContiene(TODO_INCLUIDO_3_5GB_WFT_VOZ)
        );

        // Guardar información para validación en CMAX
        actor.remember("VALOR_COMPRA", valorFormateado);
        actor.remember("PAQUETE_CANAL", TODO_INCLUIDO_3_5GB_WFT_VOZ);
    ...
    public static Performable paq3_5GB_WFT_VozIlimi() {
        return instrumented(Paq3_5GB_WFT_VozIlimi.class);
    }
}