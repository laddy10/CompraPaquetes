...
public class Paq30GBVozSMSNacional implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                EsperarYClickSeleccionaEnUltimoMensaje.conTimeout(20),
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(TODO_INCLUIDO_30GB_VOZ_SMS_ILIM));
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(TODO_INCLUIDO_30GB_VOZ_SMS_ILIM));

        // Guardar información para validación en CMAX
        actor.remember("VALOR_COMPRA", valorFormateado);
        actor.remember("PAQUETE_CANAL", TODO_INCLUIDO_30GB_VOZ_SMS_ILIM);
    ...
    public static Performable paq30GBVozSMSNacional() {
        return instrumented(Paq30GBVozSMSNacional.class);
    }
}