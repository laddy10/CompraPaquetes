...
public class PaqDatos400MBWFT implements Task {

    String precioTexto = PRECIO_$3000_1DIA_400MB;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(PQ_DATOS_400MB_WFT));

        CapturaDePantallaMovil.tomarCapturaPantalla("captura_pantalla");

        actor.attemptsTo(
                ClickTextoQueContengaX.elTextoContiene(ENVIAR2),
                ValidarTextoQueContengaX.elTextoContiene(PRECIO_$3000_1DIA_400MB),
                ValidarTextoQueContengaX.elTextoContiene(PQ_DATOS_400MB_WFT));

        // Guardar información para validación en CMAX
        actor.remember("VALOR_COMPRA", valorFormateado);
        actor.remember("PAQUETE_CANAL", PQ_DATOS_400MB_WFT);
    ...
    public static Performable paqDatos400MBWFT() {
        return instrumented(PaqDatos400MBWFT.class);
    }
}