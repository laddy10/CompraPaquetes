...
public class PaqDatosIlimitados implements Task {

    String precioTexto = PRECIO_$6000_2HORAS;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(PQ_DATOS_ILIMITADOS));

        CapturaDePantallaMovil.tomarCapturaPantalla("captura_pantalla");

        actor.attemptsTo(
                ClickTextoQueContengaX.elTextoContiene(ENVIAR2),
                ValidarTextoQueContengaX.elTextoContiene(PRECIO_$6000_2HORAS),
                ValidarTextoQueContengaX.elTextoContiene(PQ_DATOS_ILIMITADOS));

        // Guardar información para validación en CMAX
        actor.remember("VALOR_COMPRA", valorFormateado);
        actor.remember("PAQUETE_CANAL", PQ_DATOS_ILIMITADOS);
    ...
    public static Performable paqDatosIlimitados() {
        return instrumented(PaqDatosIlimitados.class);
    }
}