...
public class PaqLDIPreferencial50Minutos implements Task {

    String precioTexto = PRECIO_$23900_50MIN;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(PRECIO_$23900_50MIN)
        );
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(PRECIO_$23900_50MIN),
        ...
        actor.remember("PRECIO_SELECCIONADO", PRECIO_$23900_50MIN);
        actor.remember("VALOR_COMPRA", valorFormateado);
    }

    public static Performable paqLDIPreferencial50Minutos() {
        return instrumented(PaqLDIPreferencial50Minutos.class);
    }
}