...
public class PaqLDISinFronteras100Min implements Task {

    String precioTexto = PRECIO_$31900_100MIN;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(PRECIO_$31900_100MIN)
        );
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(PRECIO_$31900_100MIN),
        ...
        actor.remember("PRECIO_SELECCIONADO", PRECIO_$31900_100MIN);
        actor.remember("VALOR_COMPRA", valorFormateado);


    }

    public static Performable paqLDISinFronteras100Min() {
        return instrumented(PaqLDISinFronteras100Min.class);
    }
}