...
import static utils.ConstantsPaquetes.PQ_LDI_VENEZUELA;

public class SeleccionarPaqLDIVenezuela implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ClickTextoQueContengaX.elTextoContiene(PQ_LDI_VENEZUELA),
                WaitFor.aTime(2000)
        );
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ValidarTextoQueContengaX.elTextoContiene(PQ_LDI_VENEZUELA),
    ...
    public static Performable seleccionarPaqLDIVenezuela() {
        return instrumented(SeleccionarPaqLDIVenezuela.class);
    }
}