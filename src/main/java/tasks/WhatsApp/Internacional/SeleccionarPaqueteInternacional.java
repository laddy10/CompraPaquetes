...
import static utils.ConstantsPaquetes.PAQ_INTERNACIONAL_WH;

public class SeleccionarPaqueteInternacional implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ClickTextoQueContengaX.elTextoContiene(PAQ_INTERNACIONAL_WH));
    ...
    public static Performable seleccionarPaqueteInternacional() {
        return instrumented(SeleccionarPaqueteInternacional.class);
    }
}