...
public class PaqLDIPreferencial100Minutos implements Task {

    String precioTexto = PRECIO_$44900_100MIN;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(PRECIO_$44900_100MIN)
        );
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(PRECIO_$44900_100MIN),
        ...
        actor.remember("PRECIO_SELECCIONADO", PRECIO_$44900_100MIN);
        actor.remember("VALOR_COMPRA", valorFormateado);

    }

    public static Performable paqLDIPreferencial100Minutos() {
        return instrumented(PaqLDIPreferencial100Minutos.class);
    }
}