...
public class PaqLDISinFronteras200Min implements Task {

    String precioTexto = PRECIO_$59900_200MIN;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(PRECIO_$59900_200MIN)
        );
        ...
        actor.attemptsTo(
                ...
                ValidarTextoQueContengaX.elTextoContiene(PRECIO_$59900_200MIN),
        ...
        actor.remember("PRECIO_SELECCIONADO", PRECIO_$59900_200MIN);
        actor.remember("VALOR_COMPRA", valorFormateado);

    }

    public static Performable paqLDISinFronteras200Min() {
        return instrumented(PaqLDISinFronteras200Min.class);
    }
}