...
public class PaqLDIUSACANPRMEX120Min implements Task {

    String precioTexto = PRECIO_$9900_120MIN;
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ClickElementByText.clickElementByText(PRECIO_$9900_120MIN));

        CapturaDePantallaMovil.tomarCapturaPantalla("captura_pantalla");

        actor.attemptsTo(
                ClickTextoQueContengaX.elTextoContiene(ENVIAR2),
                ValidarTextoQueContengaX.elTextoContiene(PRECIO_$9900_120MIN),
        ...
        actor.remember("PRECIO_SELECCIONADO", PRECIO_$9900_120MIN);
        actor.remember("VALOR_COMPRA", valorFormateado);


    }

    public static Performable paqLDIUSACANPRMEX120Min() {
        return instrumented(PaqLDIUSACANPRMEX120Min.class);
    }
}