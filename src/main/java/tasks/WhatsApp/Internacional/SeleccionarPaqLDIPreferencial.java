...
import static utils.ConstantsPaquetes.PQ_LDI_PREFERENCIAL;

public class SeleccionarPaqLDIPreferencial implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                ...
                ClickTextoQueContengaX.elTextoContiene(PQ_LDI_PREFERENCIAL),
                WaitFor.aTime(2000)
        );
        ...
        actor.attemptsTo(
                ...
                WaitFor.aTime(2000),
                ValidarTextoQueContengaX.elTextoContiene(PQ_LDI_PREFERENCIAL),
    ...
    public static Performable seleccionarPaqLDIPreferencial() {
        return instrumented(SeleccionarPaqLDIPreferencial.class);
    }
}