...
public class SeleccionarOpcionPago implements Task {

    private static final Logger LOGGER = Logger.getLogger(CapturaDePantallaMovil.class.getName());

    private final String option;

    public SeleccionarOpcionPago(String option) {
        this.option = option;
    }

    public static SeleccionarOpcionPago comprapaquete(String option) {
        return new SeleccionarOpcionPago(option);
    }
