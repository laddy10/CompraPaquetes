...
public class CompraPaquete implements Task {

    private final String option;

    public CompraPaquete(String option) {
        this.option = option;
    }

    public static CompraPaquete comprapaquete(String option) {
        return new CompraPaquete(option);
    }
